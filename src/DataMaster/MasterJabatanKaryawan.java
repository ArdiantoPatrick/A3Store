...
public class MasterJabatanKaryawan extends JFrame{
    ...
    public JPanel JPJabatanKaryawan;
    ...
    public MasterJabatanKaryawan(){
        model = new DefaultTableModel();
        tableView.setModel(model);
        setContentPane(JPJabatanKaryawan);
        addColomn();
        autokode();
        loadData();
        btnSimpan.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(found) {
                    JOptionPane.showMessageDialog(null, "Deskripsi Jabatan Sudah Ada!", "Peringatan",
                    ...
                    try{
                        ...
                        JOptionPane.showMessageDialog(null, "Mohon untuk mengisi seluruh data!");
                            ...
                            String query2 = "EXEC sp_InsertJabatanKaryawan @Id_Jabatan=?, @Nama_Jabatan=?";
        ...
        btnUbah.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (id.equals("") | nama.equals("")){
                    ...
                    try {
                        String query2 = "UPDATE Jabatan_Karyawan SET Nama_Jabatan=? WHERE Id_Jabatan=?";
                        connection.pstat = connection.conn.prepareStatement(query2);
                ...
                if (txtNama.getText().equals("")) {
                    ...
                    try {
                        ...
                        if (opsi != 0) {
                            ...
                            String query = "EXEC sp_DeleteJabatanKaryawan @Id_Jabatan =?";
        ...
        btnCari.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String query = "SELECT * FROM Jabatan_Karyawan WHERE Id_Jabatan = '" + txtCari.getText() + "' AND Status = 1";
    ...
    public void autokode(){
        try{
            String sql = "SELECT * FROM Jabatan_Karyawan ORDER BY Id_Jabatan desc";
            connection.stat = connection.conn.createStatement();
            connection.result = connection.stat.executeQuery(sql);
            if (connection.result.next()) {
                autokode = connection.result.getString("Id_Jabatan").substring(4);
    ...
    public void loadData(){
        ...
        try{
            connection.stat = connection.conn.createStatement();
            String query = "SELECT * FROM Jabatan_Karyawan WHERE Status = 1";
            connection.result = connection.stat.executeQuery(query);
